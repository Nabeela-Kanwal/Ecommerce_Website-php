										...
										<div class="accordion__body">
											<div class="paymentinfo">
												<div class="single-method">
													Easypaisa <input type="radio" name="payment_type" value="easypaisa" required/>
													&nbsp;&nbsp;JazzCash <input type="radio" name="payment_type" value="jazzcash" required/>
												</div>
												<div class="single-method">
